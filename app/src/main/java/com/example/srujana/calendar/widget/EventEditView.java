package com.example.srujana.calendar.widget;
...
import com.example.srujana.calendar.CalendarUtils;
import com.example.srujana.calendar.R;
import com.example.srujana.calendar.ViewUtils;
import com.example.srujana.calendar.content.CalendarCursor;

/**
 * Edit view for an event in {@link CalendarContract.Events}
 */
public class EventEditView extends RelativeLayout {
    ...
    /**
     * Sets data source for calendars from {@link CalendarContract.Calendars}
